...
//	let chngFld = dropSel[i].querySelector("div:first-child");
	...
	lsOpt.style.display = 'none';
	lsOpt.style.transform = 'scaleY(0)';
	let flag = false;
	function dropSelClos() {
		setTimeout(function(){lsOpt.style.transform = 'scaleY(0)';dropArr.classList.remove("opn");}, 20);
		setTimeout(function(){lsOpt.style.display = 'none';flag = false;}, 300);}
